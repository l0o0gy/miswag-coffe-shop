...
function CoffeeDetails() {
    ...
    const [fullCups, setFullCups] = useState({ s: false, m: false, l: false });
    const [coffeeCount, setCoffeeCount] = useState(1);

    const handleCupClick = (size) => {
        setFullCups((prev) => ({ ...prev, [size]: !prev[size] }));
    };
    ...
    return (
        <div className="md:flex md:justify-start m-5 mt-0 md:p-5 md:mt-0 md:m-16">
            ...
            <div className="md:pl-10 pt-5 md:pt-0">
                ...
                <div className="flex md:justify-center items-center mt-4 md:mt-6 space-x-4">
                    {['s', 'm', 'l'].map((size) => (
                        <div key={size} className="flex flex-col items-center">
                            <img
                                src={fullCups[size] ? fullcup : emptycup}
                                alt={`Cup ${size}`}
                ...
                <div className='relative h-12 w-40 md:h-12'>
